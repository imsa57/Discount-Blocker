...
${errorInfo.componentStack}`);
  ...
  // extensions/checkout-timer/src/components/TimerText.jsx
  var import_react15 = __toESM(require_react());
  var import_jsx_runtime4 = __toESM(require_jsx_runtime());
  var TimerText = ({ timeProps }) => {
    const [time, setTime] = (0, import_react15.useState)(timeProps);
    ...
    const getTimeInFormate = () => {
      ...
      return `${minutesLeft.toString().padStart(2, "0")}:${secondLeft.toString().padStart(2, "0")}`;
    };
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Text2, { emphasis: "bold", appearance: "critical", children: getTimeInFormate() });
  };
  var TimerText_default = TimerText;

  // extensions/checkout-timer/src/Checkout.jsx
  ...
  function Extension() {
    ...
    const countdownTimeInSecond = (countdown_time != null ? countdown_time : timerTextValues.COUNTDOWN_TIME) * 60;
    return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(BlockStack2, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
        View2,
        {
          ...
          cornerRadius: "base",
          background: "subdued",
          children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Heading2, { level: "3", inlineAlignment: "center", children: timer_warning_text || timerTextValues.TIMER_WARNING_TEXT })
        }
      ),
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(View2, { inlineAlignment: "center", background: "base", children: /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(Text2, { size: "base", emphasis: "bold", children: [
        timer_small_text || timerTextValues.TIMER_SMALL_TEXT,
        " ",
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(TimerText_default, { timeProps: countdownTimeInSecond })
      ] }) })
    ] });
  }
})();
//# sourceMappingURL=checkout-timer.js.map
