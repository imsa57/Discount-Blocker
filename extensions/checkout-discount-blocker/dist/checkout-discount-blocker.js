...
${errorInfo.componentStack}`);
  ...
  function Extension() {
    ...
    const [tagfound, setTagFound] = (0, import_react12.useState)(false);
    const discountcodeCart = useDiscountAllocations();
    const allCartLineDiscount = (0, import_react12.useMemo)(
      () => cartItem.map((item) => item.discountAllocations).flat().map((item) => {
        if (item.type == "code") {
          return item.code;
        } else {
          return item.title;
    ...
    const allCartDiscount = (0, import_react12.useMemo)(
    ...
    (0, import_react12.useEffect)(() => {
      ...
      const getProductTags = () => __async(this, null, function* () {
        const queryBody = `{
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(import_jsx_runtime4.Fragment, { children: tagfound ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(View2, { padding: "tight", inlineAlignment: "center", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Text2, { appearance: "critical", children: "You can't apply discount code..." }) }) : null });
  }
})();
