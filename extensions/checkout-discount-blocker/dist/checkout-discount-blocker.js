...
${errorInfo.componentStack}`);
  ...
  // extensions/checkout-discount-blocker/src/Checkout.jsx
  ...
  function Extension() {
    ...
    const [tagfound, setTagFound] = (0, import_react11.useState)(false);
    const [showMessage, setShowMessage] = (0, import_react11.useState)(false);
    const allCartLineDiscount = (0, import_react11.useMemo)(
      () => cartItem.map((item) => item.discountAllocations).flat().map((item) => item.type === "code" ? item.code : item.title),
      [cartItem]
    );
    const allCartDiscount = (0, import_react11.useMemo)(
      () => discountcodeCart.map(
        (item) => item.type === "code" ? item.code : item.title
      ),
      [discountcodeCart]
    );
    (0, import_react11.useEffect)(() => {
      ...
      function getProductTags() {
        ...
        nodes(ids: ${JSON.stringify(productIds)}) {
          ...
          try {
            const { data } = yield query(queryBody);
    ...
    (0, import_react11.useEffect)(() => {
      ...
      if (tagfound && allDiscountCode.length) {
        allDiscountCode.forEach(
          (item) => discountCodeFunction({
            code: item,
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(import_jsx_runtime4.Fragment, { children: showMessage && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Text2, { appearance: "critical", children: "You can not apply a discount code..." }) });
  }
})();
//# sourceMappingURL=checkout-discount-blocker.js.map
